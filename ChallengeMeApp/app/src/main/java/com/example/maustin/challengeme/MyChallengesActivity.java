...
public class MyChallengesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Challenge challenge : applicationState.getMyChallenges()){
            String name = challenge.getName();
            challengeNames.add(name);
        }

        ArrayAdapter<String> challengeNamesArrayAdapter = new ArrayAdapter<String>(this, R.layout.activity_my_challenges, challengeNames);

        TextView challengeNamesTextView = findViewById(R.id.myChallengesID);
        challengeNamesTextView.setAdapter(challengeNamesArrayAdapter);
